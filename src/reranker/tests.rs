...
#[test]
fn score_readback_validates_shape_and_nan_before_returning_scores() {
    use super::processing::scores_from_logits;
    assert_eq!(scores_from_logits(&[0.0, 0.0], 2, 128).unwrap(), [0.5, 0.5]);
